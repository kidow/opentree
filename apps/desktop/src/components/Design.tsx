  ...
  return (
    <main className="design">
      ...
      <div className="design-body">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="design-tabs">
          <TabsList variant="line" className="design-tabs-list">
            <TabsTrigger value="colors">색상</TabsTrigger>
            <TabsTrigger value="buttons">버튼 스타일</TabsTrigger>
            <TabsTrigger value="layout">레이아웃</TabsTrigger>
            <TabsTrigger value="background">배경</TabsTrigger>
            <TabsTrigger value="font">폰트</TabsTrigger>
            <TabsTrigger value="css">Custom CSS</TabsTrigger>
            <TabsTrigger value="bundle">Bundle</TabsTrigger>
          </TabsList>

          <TabsContent value="colors" className="design-panel">
            {wcagBad && (
          ...
          <TabsContent value="buttons" className="design-panel">
          ...
          <TabsContent value="layout" className="design-panel">
            <div className="preset-row">
              {LAYOUTS.map((l) => (
                <button
                  key={l.id}
          ...
          <TabsContent value="background" className="design-panel">
            <div className="preset-row">
              <button
          ...
          <TabsContent value="font" className="design-panel">
            <div className="design-field">
          ...
          <TabsContent value="css" className="design-panel">
            <div className="design-field">
          ...
          <TabsContent value="bundle" className="design-panel">
            <div className="design-field">
      ...
      <style>{`
        .design { display: flex; flex-direction: column; height: 100%; min-height: 0; overflow: hidden; background: var(--bg); }
        .design-tabs { display: flex; flex-direction: column; min-height: 0; flex: 1; }
        .design-tabs-list { padding: 6px 24px 0; }
        .design-panel { display: flex; flex: 1; flex-direction: column; gap: 24px; padding: 0; min-height: 0; overflow-y: auto; }
        .design-panel > * { flex-shrink: 0; }
        ...
        .design-body { flex: 1; min-height: 0; overflow-y: auto; padding: 0; display: flex; flex-direction: column; gap: 0; }
        ...
        .design-field { background: var(--surface); border: 1px solid var(--border); border-radius: 0; padding: 14px; display: flex; flex-direction: column; gap: 4px; }
        ...
        .color-row:first-child { border-top: 1px solid var(--border); }
